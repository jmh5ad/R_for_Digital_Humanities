library(holepunch)
write_compendium_description(package = "R_for_Digital_Humanities", 
                             description = "Files for learning R from a humanistic point of view.")
# to write a description, with dependencies listed 
# It's good practice to now go fill in the placeholder text.

write_dockerfile(maintainer = "J.Huband") 
